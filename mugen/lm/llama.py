"""The code is from https://github.com/Lightning-AI/lit-llama/blob/main/lit_llama/model.py
"""
...
class LLaMA(nn.Module):
    ...
    def forward(
        self, idx: torch.Tensor, targets=None, max_seq_length: Optional[int] = None, input_pos: Optional[torch.Tensor] = None
